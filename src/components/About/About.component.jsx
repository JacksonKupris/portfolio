        ...
        <div className="about-container">
          ...
          <div className="about-paragraph">
            <p>
              ...
              on a variety of projects spanning from proprietary Python projects
              to web-based solutions. I have experience with React, Python,
              Django, SQL, and GIT, and I am always eager to learn and explore
              new technologies that can help me build better software. I believe
              ...
              exploring new camp sites or playing my favorite games. I also
              enjoy reading books on technology and entrepreneurship, which
              helps me stay up-to-date with the latest trends and ideas in the
              industry. Thank you for taking the time to learn a bit about me. I
              look forward to working with you and creating exceptional software
